...
{
    // If AttributeSet is invalid, recreate it
    if (!IsValid(AttributeSet))
    {
        UE_LOG(LogActionRPG, Warning, TEXT("Recreating AttributeSet in OnConstruction for %s"), *GetNameSafe(this));
        AttributeSet = NewObject<URPGAttributeSet>(this, TEXT("AttributeSet"));
    }
